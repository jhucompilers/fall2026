...
In the root of your local clone of your project repository,
download [assign01.zip](assign01.zip) and unzip it:

```
wget https://jhucompilers.github.io/fall2026/assign/assign01.zip
unzip assign01.zip
rm assign01.zip
```

These commands will create a directory called `assign01` which
contains the starter code. Add, commit, and push the starter code:

```
git add assign01
git commit -m'assignment 1 starter code'
git push
```
...
The [fall2026-tests](https://github.com/jhucompilers/fall2026-tests)
repository has some tests you can use to check your implementation.
First, clone the test repository:

```
git clone https://github.com/jhucompilers/fall2026-tests.git compilers-fall2026-tests
```
...
as **Assignment 1**. Note that you should log into Gradescope by going to the
course's Canvas site in MyJHU and clicking the "Gradescope" link.
